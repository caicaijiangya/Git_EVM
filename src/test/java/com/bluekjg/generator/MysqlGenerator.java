...
public class MysqlGenerator {
	public static Logger logger = LogManager.getLogger(MysqlGenerator.class.getName());
	/**
	 * <p>
	 * MySQL 生成演示
	 * </p>
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "t_evm_authority" }); // 需要生成的表
		...
		pc.setParent("com.bluekjg.admin"); // 自定义包路径
