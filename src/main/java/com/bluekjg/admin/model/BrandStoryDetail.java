 ...
 * @since 2018-10-09
 */
@TableName("t_evm_brand_story_detail")
public class BrandStoryDetail extends Model<BrandStoryDetail> {
     ...
     * 最后修改时间
     */
    @TableField(value="brand_story_id")
