...
public class UnifiedorderUtil {
	...
	private static final Logger log = LoggerFactory.getLogger(UnifiedorderUtil.class);
	
	// 
	public final static String GET_MICROPAY_URL = "https://api.mch.weixin.qq.com/sandboxnew/pay/unifiedorder";
	...
	public static synchronized String getSignKey() {
		try {
			...
			xml.append("<total_fee>552</total_fee>").append("\n");
