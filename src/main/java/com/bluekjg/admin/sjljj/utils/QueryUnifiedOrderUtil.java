 ...
 *
 */
public class QueryUnifiedOrderUtil {
	
	private static final Logger log = LoggerFactory.getLogger(QueryUnifiedOrderUtil.class);
	
	// 
	public final static String GET_MICROPAY_URL = "https://api.mch.weixin.qq.com/sandboxnew/pay/orderquery";
