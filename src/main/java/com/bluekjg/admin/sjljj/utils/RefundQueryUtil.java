...
public class RefundQueryUtil {
	...
	private static final Logger log = LoggerFactory.getLogger(RefundQueryUtil.class);
	
	// 
	public final static String GET_MICROPAY_URL = "https://api.mch.weixin.qq.com/sandboxnew/pay/refundquery";
