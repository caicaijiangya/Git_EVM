...
import com.bluekjg.admin.mapper.RoleMapper;
import com.bluekjg.admin.mapper.RoleResourceMapper;
import com.bluekjg.admin.mapper.UserRoleMapper;
import com.bluekjg.admin.model.Role;
import com.bluekjg.admin.model.RoleResource;
import com.bluekjg.admin.service.IRoleService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    public void selectDataGrid(PageInfo pageInfo) {
        ...
        EntityWrapper<Role> wrapper = new EntityWrapper<Role>();
        wrapper.addFilter("is_del = 0");
        wrapper.orderBy("seq", pageInfo.getOrder().equalsIgnoreCase("ASC"));
