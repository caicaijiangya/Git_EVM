...
public class ImportExecl {
	public static Logger logger = LogManager.getLogger(ImportExecl.class.getName());
	/** 总行数 */
	...
	public List<List<String>> read(File file) {
		...
		try {
			...
			dataLst = read(is, WDWUtil.isExcel2003(file.getPath()));
	...
	public static void main(String[] args) throws Exception {
		...
		List<List<String>> list = poi.read("F:\\aaaa.xlsx");
