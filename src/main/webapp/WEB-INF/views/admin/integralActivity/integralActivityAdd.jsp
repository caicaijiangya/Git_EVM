...
<script type="text/javascript">
    $(function() {
        $('#integralActivityAddForm').form({
            url : '${path }/integralActivity/add',
            onSubmit : function() {
                progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="integralActivityAddForm" method="post" >
            ...
            <table class="grid">
                ...
                <tr>
                    ...
                    <td>
                    	<input name="type" value="1" type="radio" checked="checked">多倍积分
                    	<input name="type" value="2" type="radio" >邀请好友获得积分
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="multiple" type="number" class="easyui-validatebox span2" data-options="required:true" value="1"></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">赠送积分</td>
                    <td><input name="integral" type="number" class="easyui-validatebox span2" data-options="required:true" value="0"></td>
                </tr>
            </table>
        </form>
    </div>
