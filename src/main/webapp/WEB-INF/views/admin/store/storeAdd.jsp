...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="storeAddForm" method="post" >
            <table class="grid">
                <tr>
                    <td align="right" bgcolor="#f8f8f8">门店编码:</td>
                    <td><input name="storeNo" type="text" placeholder="请输入门店编码" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">门店名称:</td>
                    <td><input name="storeName" type="text" placeholder="请输入门店名称" class="easyui-validatebox span2" value="" data-options="required:true"></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">门店位置-经度:</td>
                    <td><input name="longitude" type="number" placeholder="请输入门店位置经度" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">门店位置-纬度:</td>
                    <td><input name="latitude" type="number" placeholder="请输入门店位置纬度" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">门店电话:</td>
                    <td><input name="mobileNo" type="text" placeholder="请输入门店联系电话" class="easyui-validatebox span2" value="" data-options="required:true"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea name="addressDetail" rows="4" style="width:95%;"></textarea></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">打印机设备号:</td>
                    <td><input name="deviceId" type="text" placeholder="请输入打印机设备号" class="easyui-validatebox span2" value="" ></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#f8f8f8">打印机设备密钥:</td>
                    <td><input name="deviceSecret" type="text" placeholder="请输入打印机密钥" class="easyui-validatebox span2" value="" ></td>
                </tr>
            </table>
        </form>
    </div>
