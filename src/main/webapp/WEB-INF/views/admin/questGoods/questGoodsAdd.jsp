...
<script type="text/javascript">
    $(function() {
        $('#questGoodsAddForm').form({
            url : '${path }/questGoods/add',
            onSubmit : function() {
                progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="questGoodsAddForm" method="post" >
            <table class="grid">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                    	<input name="nail" value="0" type="radio" checked="checked">固定
                    	<input name="nail" value="1" type="radio" >周期一
                    	<input name="nail" value="2" type="radio" >周期二
                    	<input name="nail" value="3" type="radio" >基础商品
                    </td>
                </tr>
                <tr>
