...
<script type="text/javascript">
    $(function() {
        ...
        $('#fullParameterEditForm').form({
            url : '${path }/activity/editFull',
            onSubmit : function() {
                progressLoad();
                if (endEditing1()){
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: scroll;padding: 3px;" >
        <form id="fullParameterEditForm" method="post">
        	<input name="activityId" type="hidden" value="${id }"/>
        	<input name="fullPrices" type="hidden" value=""/>
        	<input name="prePrices" type="hidden" value=""/>
			<div id="priceList">
	            <table id="dg1" class="easyui-datagrid" title="优惠条件配置" style="width:100%;height:auto;"
				data-options="
					iconCls: 'icon-edit',
					singleSelect: true,
					toolbar: '#tb1',
					url: 'activity/fullDataGrid?id=${id }',
					method: 'post',
					onClickRow: onClickRow1
				">
					<thead>
						<tr>
							<th data-options="field:'fullPrice',width:150,align:'left',editor:{type:'numberbox',options:{precision:2}}">条件</th>
							<th data-options="field:'prePrice',width:150,align:'left',editor:{type:'numberbox',options:{precision:2}}">优惠金额</th>
						</tr>
					</thead>
				</table>
