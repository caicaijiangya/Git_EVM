...
<div class="easyui-layout" data-options="fit:true,border:false">
                ...
                <tr>
                    ...
                    <td>
                       <input type="text" class="easyui-validatebox"  id="starttime"
					 		name="createdateStart" placeholder="选择开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',onpicked:function(){stop_time.focus();},maxDate:'%y-%M-%d'})" readonly="readonly" style="background-color: white;"
					 		value=""  />
                    </td>
                    <th>&nbsp;&nbsp;至&nbsp;&nbsp;</th>
                    <td>
				 		<input type="text" class="easyui-validatebox"  id="stop_time"
				 		name="createdateEnd" placeholder="选择结束时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'starttime\')}'})" readonly="readonly" style="background-color: white;"
				 		value="" />
                    </td>
                    <td>
    ...
    <div data-options="region:'west',border:true,split:false,title:'组织机构'" style="width:180px; ">
     	 <ul id="organizationTree" style="padding: 5px;"></ul>
    </div>
</div>
