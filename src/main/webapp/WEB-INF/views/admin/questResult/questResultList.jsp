...
$(function() {
	$('#questResultExportForm').form({
        url : '${path }/questResult/export_qr',
        onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false" style="margin: 20px;">
	<div class="easyui-panel" title="问卷测试数据" style="width:600px;">
		<div style="padding:10px 60px 20px 60px">
		    <form id="questResultExportForm" method="post">
		    	<table class="grid">
		    		<tr>
